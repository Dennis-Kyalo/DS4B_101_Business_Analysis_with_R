...
## Alternative using pivot_wider instead of spread
bikeshop_revenue_tbl %>% 
...
## Alternative using pivot_longer instead of gather and parse number
bikeshop_revenue_formatted_tbl %>% 
    pivot_longer(cols = !`Bikeshop Name`, names_to = "category_1", values_to = "sales") %>% 
